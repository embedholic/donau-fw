...
/* Configure eCAN for HECC mode - (reqd to access mailboxes 16 thru 31) */
	...
	ECanaShadow.CANMC.bit.ABO = 1; // 128 * 11 비트 연속 수신 후 Bus off 자동으로 clear
...
/* Configure bit timing parameters for eCANA*/
	...
	/* The following block for all 300 MHz SYSCLKOUT (75 MHz CAN clock) - default. Bit rate = 1 Mbps
	   See Note at end of file. */
		ECanaShadow.CANBTC.bit.BRPREG = 4; // 250kbps.  1M, 500k, 250k, 125k, 100k, 50k = 4, 9, 19, 39, 49, 99
...
/* Configure eCAN for HECC mode - (reqd to access mailboxes 16 thru 31) */
	...
	ECanbShadow.CANMC.bit.ABO = 1; // 128 * 11 비트 연속 수신 후 Bus off 자동으로 clear
...
/* Configure bit timing parameters for eCANB*/
	...
	/* The following block for all 300 MHz SYSCLKOUT (75 MHz CAN clock) - default. Bit rate = 1 Mbps
	   See Note at end of file. */
		...
		ECanbShadow.CANBTC.bit.BRPREG = 9;	// 1M, 500k, 250k, 125k, 100k, 50k = 4, 9, 19, 39, 49, 99
